...
Evaluate the changes using the checklist in [references/quality_checklist.md](file:///.agents/skills/quality-reviewer/references/quality_checklist.md):
...
Using the template in [references/review_report_template.md](file:///.agents/skills/quality-reviewer/references/review_report_template.md), create `wiki/<NNN>-<feature>/quality-review.md`:
...
```bash
python .agents/skills/quality-reviewer/scripts/validate_quality_review.py wiki/<NNN>-<feature>/quality-review.md
```
