...
| Skill                                          | Description                                                                                                                                                                                                                                                      |
| ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [init-agents](skills/init-agents/)             | Analyzes repository structure, configurations, and conventions to generate a comprehensive `AGENTS.md` guide for AI agent collaboration.                                                                                                                        |
| [read-paper](skills/read-paper/)               | Read and analyze a single research paper using the 4-pass reading strategy and PACES framework. Cross-references with `MEMORY.md` and saves structured Markdown to `docs/paper_summary/`.                                                                       |
